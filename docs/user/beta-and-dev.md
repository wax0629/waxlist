...
| 能力 | 说明 |
|------|------|
| 优质发行 | 列表 / 详情 / UDG 专区 / 筛选（红心·站主爱听·友情）/ 排序（推荐先后·发行时间） |
| 荐专与内容管理 | 所有登录用户提交后默认上架；推荐理由可留空；管理浏览近期内容并事后下架；旧版待审记录仍可清理 |
| 互动 | 红心、曲目推荐、友情标签（站主）；评分/评论公开可读，发布仅对站主及指定账号开放 |
...
- [ ] 红心可用；普通账号可查看但不能发布评分/评论，互动内测账号可发布
- [ ] 关于页联系方式正确
