...
export function BeatCard({ beat }: { beat: BeatCandidate }) {
  return (
    <a
      ...
      className="group flex flex-col gap-2 overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-black/20 backdrop-blur-md transition hover:border-violet-400/40 hover:bg-white/[0.08]"
    >
      {beat.thumbnail ? (
